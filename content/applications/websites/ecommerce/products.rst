...
to their wishlist, i.e. saving them for later. To enable it, go to
:menuselection:`Website --> Configuration --> Settings`, scroll down to the
:guilabel:`Shop - Products` section, and enable :guilabel:`Wishlists`.
...
.. tip::
   ...
   .. image:: products/products-save-for-later.png
