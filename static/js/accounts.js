...
(function () {
    ...
    var __BG = {
        ...
        "Company Incorporation (Initial Capital $1,000)": "Учредяване на дружество (начален капитал 1000 лв.)",
        "Customer Invoice ($100 + 9% tax) & Shipping of the Goods": "Фактура към клиент (100 лв. + 20% ДДС) и експедиция на стоките",
        ...
        "Vendor Goods Received (Purchase Order: $50)": "Получени стоки от доставчик (поръчка: 50 лв.)",
        "Vendor Bill (Invoice: $50)": "Фактура от доставчик (фактура: 50 лв.)",
        "Vendor Bill (Invoice: $52 but PO $50)": "Фактура от доставчик (фактура: 52 лв. при поръчка 50 лв.)",
        "Vendor Bill Paid ($52 + 9% tax)": "Платена фактура от доставчик (52 лв. + 20% ДДС)",
        ...
        "Customer Invoice (3 years service contract, $300)": "Фактура към клиент (3-годишен сервизен договор, 300 лв.)",
        ...
        "Supplier Goods Received (Purchase Order: $50)": "Получени стоки от доставчик (поръчка: 50 лв.)",
